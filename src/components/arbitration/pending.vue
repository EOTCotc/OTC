  ...
  <div class="content">
    ...
    >
      <div class="listbox">
        ...
        <div v-if="proofStatic == 0" class="details">
          <van-cell
            icon="orders-o"
            title="仲裁详情"
            is-link
        ...
        <div v-else-if="proofStatic == 1" class="buttons">
          <van-button type="info" plain round :to="{ name: 'anew' }"
            >重新举证</van-button
          >
          <van-button type="info" round :to="{ name: 'details' }">
            <van-icon name="star-o" />
            去判决</van-button
          >
        </div>
        <div class="judgmentbox"  v-else>
            <div>
              <p>你的判决</p>
              <div>
                <van-icon name="star-o" />
